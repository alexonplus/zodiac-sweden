export class SoundEngine {
  ...
  playSword() {
    ...
    osc.frequency.linearRampToValueAtTime(1400, this.ctx.currentTime + 0.1);
  ...
  playUlt() {
    ...
    gain.gain.linearRampToValueAtTime(0.01, this.ctx.currentTime + 0.85);
    osc.connect(gain);
    gain.connect(this.ctx.destination);
    osc.start();
  ...
  playRoar() {
    ...
    osc.frequency.exponentialRampToValueAtTime(45, this.ctx.currentTime + 0.7);
